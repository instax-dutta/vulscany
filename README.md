...
- Merged `vulscany-landing` into the main application.
- Unified deployment at `example.com` (removed `app.example.com` subdomain requirement).
...
1. **Create OAuth App**: https://github.com/settings/developers
   ...
   - Callback: `https://example.com/api/auth/callback`
