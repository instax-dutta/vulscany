...
- Use the new domain (`app.aeglyn.site`)
...
```
https://app.aeglyn.site/api/auth/callback
```
...
2. Select your project (vulscany → will deploy to app.aeglyn.site)
...
2. Make sure the callback URL is exactly: `https://app.aeglyn.site/api/auth/callback`
...
3. Production: `https://app.aeglyn.site`
...
- [ ] Homepage URL set to `https://aeglyn.site`
- [ ] Callback URL set to `https://app.aeglyn.site/api/auth/callback`
- [ ] Client ID copied
- [ ] Client secret generated and copied
- [ ] Environment variables updated in Vercel
- [ ] `NEXTAUTH_URL` set to `https://app.aeglyn.site`
