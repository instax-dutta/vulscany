...
1. **Landing Page** (`vulscany-landing/`) → `example.com`
2. **Application** (root) → `app.example.com`
...
```
example.com          → Vercel (landing page project)
www.example.com      → Redirect to example.com
app.example.com      → Vercel (application project)
```
...
- **Node Version**: 18.x
- **Root Directory**: `vulscany-landing`
