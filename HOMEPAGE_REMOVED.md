...
### Before
- ❌ App had its own homepage at `app.example.com/`
- ❌ Duplicate landing page content
- ❌ Confusing user experience
- ❌ Two places to maintain marketing content

### After
- ✅ App root (`app.example.com/`) now redirects intelligently
- ✅ Single source of truth for marketing: `example.com`
...
2. Automatically redirected to `https://example.com` (landing page)
3. Sees marketing content, features, pricing
4. Clicks "Get Started" or "Launch App"
5. Redirected back to `app.example.com`
...
- If not authenticated → redirect to https://example.com
...
```html
<!-- In landing page -->
<a href="https://app.example.com">Launch App</a>
...
- Vercel auto-deploys to `app.example.com`
