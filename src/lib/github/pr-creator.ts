...
async function hasExistingSecurityPR(
    ...
    try {
        ...
        // Look for PRs created by VullScanny or older legacy branches
    ...
    try {
        ...
        try {
            await octokit.issues.addLabels({
                ...
                repo,
                issue_number: number,
                labels: ['security', 'vullscanny', 'automated']
            });
        } catch (error) {
...
`;
    ...
    return `## Security Fixes by VullScanny

This PR contains automated security fixes for vulnerabilities detected by VullScanny.
...
**Generated by:** VullScanny archive tooling
